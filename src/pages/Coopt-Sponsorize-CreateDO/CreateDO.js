    ...
    <Wallet   
      ...
      <div className='actions_createdo'>
        ...
        <button  className='start-create-do' onClick={() => setCurrentQuestion(1)} >Start</button>
            ...
            <>
            <p className="create-do">Who will Pilot your D.O. as CEO?</p>
            ...
            <>
            <p className="create-do">Congratulations on creating your D.O.! {idDOcreated} Well done!<br></br>To make it active, recruit Talent to help achieve your goals.<br></br>And yes, there are Rewards for Co-opting Talent!</p>
            <div className="explain-do">
